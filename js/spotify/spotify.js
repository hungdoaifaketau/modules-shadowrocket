...
if (url.includes("bootstrap/v1/bootstrap") && method === postMethod) {
    ...
    $notification.post('spotifunlockpremium', "đường dẫ/Phương thức yêu cầu:", method + "," + url);
}
...
function processMapObj(accountAttributesMapObj) {
    accountAttributesMapObj['player-license'] = {
        stringValue: 'premium'
    };
    accountAttributesMapObj['mobile'] = {
        boolValue: true
    };
    accountAttributesMapObj['streaming-rules'] = {
        stringValue: ''
    };
    ...
    accountAttributesMapObj['mobile-login'] = {
        boolValue: true
    };
    accountAttributesMapObj['name'] = {
        stringValue: 'Spotify Premium'
    };
    accountAttributesMapObj['on-demand'] = {
        boolValue: true
    };
    accountAttributesMapObj['ads'] = {
        boolValue: false
    };
    accountAttributesMapObj['catalogue'] = {
        stringValue: 'premium'
    };
    accountAttributesMapObj['high-bitrate'] = {
        boolValue: true
    };
    accountAttributesMapObj['libspotify'] = {
        boolValue: true
    };
    accountAttributesMapObj['nft-disabled'] = {
        stringValue: '1'
    };
    accountAttributesMapObj['shuffle'] = {
        boolValue: false
    };
    accountAttributesMapObj['audio-quality'] = {
        stringValue: '1'
    };
    accountAttributesMapObj['offline'] = {
        boolValue: true
    };
    accountAttributesMapObj['pause-after'] = {
        longValue: 0
    };
    accountAttributesMapObj['can_use_superbird'] = {
        boolValue: true
    };
    accountAttributesMapObj['type'] = {
        stringValue: 'premium'
    };
    ...
    accountAttributesMapObj['shuffle-eligible'] = {
        boolValue: true
    };
    accountAttributesMapObj['unrestricted'] = {
        boolValue: true
    };
